...
mims_dist = mims %>%
  ...
  scale_fill_manual(name = "Flags", values = c("Sleep" = "#798E87", "SeB" = "#046C9A", "LiPA" = "#54D8B1", "MVPA" = "#BD3027")) +
  labs(title = "MIMS distribution") +
  geom_vline(aes(xintercept = log(lipa_cp + 1)), linewidth = 1, color = "#54D8B1") +
  geom_vline(aes(xintercept = log(mvpa_cp + 1)), linewidth = 1, color = "#BD3027") +
